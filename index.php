...
<!--                    </li>-->
    ...
    <div class="header_banner">
        <div class="header_banner__col col1">
            <div class="col1_col1"><i class="fa-solid fa-phone"></i></div>
            <div class="col1_col2">
...
<section class="section_1">
    <div class="col1">
        ...
        <div class="buttons">
            <div class="h-btn more_info">Дізнатися більше</div>
            <div class="h-btn get_consultation">Отримати консультацію</div>
        </div>
    </div>
</section>
...
<section class="section_3">
    ...
    <div class="advantages">
        ...
        <div class="advantage">
            <div class="advantage__icon"><i class="fa-solid fa-gears"></i></div>
        ...
        <div class="advantage">
            <div class="advantage__icon"><i class="fa-solid fa-screwdriver-wrench"></i></div>
        ...
        <div class="advantage">
            <div class="advantage__icon"><i class="fa-solid fa-sliders"></i></div>
        ...
        <div class="advantage">
            <div class="advantage__icon"><i class="fa-solid fa-gear"></i></div>
...
<section class="section_7">
    ...
    <div class="col1">
        ...
        <div class="item"><div><i class="fa-solid fa-check"></i></div> <span>Впишите имя и номер телефона в форму</span></div>
        <div class="item"><div><i class="fa-solid fa-check"></i></div> <span>Мы связываемся с вами, чтобы обсудить условия</span></div>
        <div class="item"><div><i class="fa-solid fa-check"></i></div> <span>Специалист замеряет все данные и составляет смету</span></div>
        <div class="item"><div><i class="fa-solid fa-check"></i></div> <span>Вы подписываете договор - а мы берёмся за дело!</span></div>
    </div>
...
<section class="section_8">
    ...
    <div class="col1">
        ...
        <div class="col1_item phone"><i class="fa-solid fa-phone"></i> +38 (123) 123-45-67</div>
        <div class="col1_item email"><i class="fa-regular fa-envelope"></i> login@domain.ua</div>
        <div class="col1_item address"><i class="fa-solid fa-location-dot"></i> г. Киев,​бульв. Шевченка, дом</div>
    </div>
